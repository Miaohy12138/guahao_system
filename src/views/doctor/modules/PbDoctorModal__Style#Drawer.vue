    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="医生等级" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="[ 'level', validatorRules.level]" placeholder="请输入医生等级" style="width: 100%"/>
        </a-form-item>
        ...
        <a-form-item label="医院id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="[ 'departmentId', validatorRules.departmentId]" placeholder="请输入医院id" style="width: 100%"/>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','level','hospitalId','departmentId','goodDisease','introduction','createTime','updateTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','level','hospitalId','departmentId','goodDisease','introduction','createTime','updateTime'))
      }
